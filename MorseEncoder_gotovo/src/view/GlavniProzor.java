	...
	private void initialize() {
		...
		btnAbout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame frame = new JFrame("O programu");
				
				JOptionPane.showMessageDialog(frame, "Napisali Josip Duvnjak i Goran Glavocevic\n" + 
				"Written by Josip Duvnjak and Goran Glavocevic"
						+ "\n			2016. \n");
